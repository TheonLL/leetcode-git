...
| 北森         | 无         | 9.15计算机网络，数据库，java比较少                           |                                    |                                |          |
| 荣耀         | 三道算法   | 9.16问的比较杂，数据结构，算法，计算机网络，数据库，多线程，集合总体不难 |                                    |                                | 人才库   |
| 招银网络科技 | 选择加算法 | 9.17问的比较简单，但是比较少八股文，手撕代码最大子序列和     |                                    |                                | 待二面   |
| 大疆         | 选择加算法 |                                                              |                                    |                                | 人才库   |
...
3. 线程安全的集合？
4. synchronized关键字和volatile关键字区别？
5. synchronized关键字可以修饰哪些；
6. synchronized修饰对象静态类的区别；
7. 了解得设计模式有哪些？
8. 讲讲单例模式？
9. 项目中用到了哪些设计模式；
10. 项目中redis用来实现什么功能，采用的那种数据结构；
11. 项目中hash的一级key和二级key怎么设置的；
12. 可以用其他的数据结构嘛；
13. 然后就是项目，简历的每个项目都问了一遍，从我的描述上问，基本是怎么实现的，具体有哪些功能。
14. 反问：
    1. 公司的技术栈；
    2. 进入公司之后具体负责什么业务；
...
8. 了解哪些数据结构；
9. 如何判断一个链表是否有环；怎么实现快慢指针；为什么快慢指针可以实现这个功能；
10. 了解哪些算法；
11. 八皇后问题怎么解决；
12. 两个专利是哪些；
13. springboot启动过程；
14. springboot启动用到了哪些java技术；
15. 项目开发的流程？
16. 自己在开发过程中遇到问题怎么解决的，举个例子;
17. 代码怎么合并到一起，有没有遇到一些问题，怎么解决的；
18. 项目中怎么评估队友的表现；
19. 如果觉得队友的实现方式不对，不好，怎么解决；
20. 如果他坚持他的想法怎么解决；
21. 反问环节；

体验极差：面试官摄像头怼墙，声音贼小，声音调最大有时候也听不清，全程贴着键盘听。
