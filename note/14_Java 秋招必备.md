...
| 北森         | 无                                                           | 9.15计算机网络，数据库，java比较少                           | 9.23快开始的时候说推迟，后续联系                     |                                |          |
| 荣耀         | 8.28三道算法                                                 | 9.16问的比较杂，数据结构，算法，计算机网络，数据库，多线程，集合总体不难 |                                                      |                                | 人才库   |
| 字节跳动     | 9.29四道算法，挺难的                                         |                                                              |                                                      |                                | 流程终止 |
| 招银网络科技 | 9.6选择加算法                                                | 9.17问的比较简单，但是比较少八股文，手撕代码最大子序列和     | 9.22体验很差，重项目，重算法，第二天上午通知约了hr面 | 9.26                           | 待三面   |
...
| 兴业数金     | 9.10选择加算法比较简单                                       | 9.16约线下面试，直接推了                                     |                                                      |                                |          |
| 去哪儿       | 9.14选择加算法，中等难度                                     |                                                              |                                                      |                                |          |
| 富途         | 9.16选择加算法，中等难度                                     |                                                              |                                                      |                                |          |
| 网易互娱     | 9.17四道算法，巨难                                           |                                                              |                                                      |                                |          |
| 玄武科技     | 9.17选择加算法，主观题，同一套题库                           | 9.24                                                         |                                                      |                                |          |
| 美的         | 9.20选择加算法，比较简单，从题库里选的，算法题重复度高       |                                                              |                                                      |                                |          |
