...
| 公司         | 一面                                                         | 二面                               | 三面                           | 状态     |
| ------------ | ------------------------------------------------------------ | ---------------------------------- | ------------------------------ | -------- |
| 用友         | 8.27全是八股文                                               | 9.1hr面，聊得还行最后叫我转部门    | 无                             | 池子     |
| 蓝月亮       | 9.10线下群面                                                 |                                    |                                | 流程终止 |
| 汇川         | 9.13，问了八股和项目，还有一些场景题                         | 9.17hr面，一些基础的问题，没有技术 | 9.17主管面，技术夹杂着生活问题 | 待开奖   |
| 北森         | 9.15计算机网络，数据库，java比较少                           |                                    |                                |          |
| 荣耀         | 9.16问的比较杂，数据结构，算法，计算机网络，数据库，多线程，集合总体不难 |                                    |                                | 流程中   |
| 招银网络科技 | 9.17问的比较简单，但是比较少八股文，手撕代码最大子序列和     |                                    |                                | 待二面   |
|              |                                                              |                                    |                                |          |
